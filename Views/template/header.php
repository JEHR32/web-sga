            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="<?php echo ($data['menu'] == 'share') ? 'active-page' : ''; ?>">
                        <a href="<?php echo BASE_URL . 'compartidos'; ?>" class="<?php echo ($data['menu'] == 'share') ? 'active' : ''; ?>"><i class="material-icons-two-tone">inbox</i>Compartir archivos<span class="badge rounded-pill badge-danger float-end"><?php echo $data['shares']['total']; ?></span></a>
                    </li>
                    <li class="<?php echo ($data['menu'] == 'admin') ? 'active-page' : ''; ?>">
                        <a href="<?php echo BASE_URL . 'admin'; ?>" class="<?php echo ($data['menu'] == 'admin') ? 'active' : ''; ?>"><i class="material-icons-two-tone">cloud_queue</i>Gestion de archivos</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="navbar-nav" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown hidden-on-mobile">
                                    <!--
                                        Esta es una seccion + donde puedes mostrar mas opciones a realizar dentro de la barra de busqueda buscar funcion
