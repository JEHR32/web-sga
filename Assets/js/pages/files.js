...
const btnNuevaSubCarpeta = document.querySelector("#btnNuevaSubcarpeta");
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    frmCaperta.addEventListener('submit', function (e) {
        ...
        if (frmCaperta.nombre.value == '') {
            ...
            //Aqui debemos de crear la funcion crear carpeta en el controlador admin
...
//fin dropzone - area de captura de archivos a  subir 
